      ...
      <section className={styles.historysection}>
        ...
        <div className={styles.historysection__music}>
          ...
          <div className={styles.historysection__artist}>
            <div className={styles.historysection__first}>Mind Set</div>
            <div className={styles.historysection__second}>
              Matthew Matthews feat. Sad adorant
            </div>
          </div>
        </div>
				<div className={styles.historysection__music}>
          <img src={historyPageImage} alt="history" />
          <div className={styles.historysection__artist}>
            <div className={styles.historysection__first}>Neverl</div>
            <div className={styles.historysection__second}>
              Matthew Matthews 
            </div>
          </div>
				...
				<h2>2024</h2>
        <h3>Orientation and direction of activity</h3>
        ...
        <div className={styles.historysection__music}>
          <img src={historyPageImage} alt="history" />
          <div className={styles.historysection__artist}>
            <div className={styles.historysection__first}>XXV</div>
            <div className={styles.historysection__second}>
              Matthew Matthews 
            </div>
          </div>
